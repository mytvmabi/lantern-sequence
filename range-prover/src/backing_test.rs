...
impl BackingTestSuite {
    ...
    pub fn compare_single_exponentiation(
        ...
        let proof = self.system.prove_single_exponentiation(base, exponent_bits)
        ...
        let verification_success = self.system.verify_single_exponentiation(&proof, zkexp_result);
        let verify_time = verify_start.elapsed().as_micros() as u64;
        
        // Calculate comparative metrics
        let prove_overhead = if traditional_time > 0 {
            prove_time as f64 / traditional_time as f64
        } else { 0.0 };
        ...
        let verification_speedup = if verify_time > 0 {
            traditional_time as f64 / verify_time as f64
        } else { 0.0 };
        ...
        Ok(BackingTestResult {
            ...
            traditional_result,
            zkexp_prove_time_us: prove_time,
            zkexp_verify_time_us: verify_time,
            zkexp_proof_size_bytes: proof.size_bytes(),
